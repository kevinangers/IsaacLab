...
from isaaclab_tasks.manager_based.manipulation.vials.vials_env_cfg import VialsEnvCfg
...
class EventCfg:
    ...
    randomize_vial_positions = EventTerm(
        func=franka_vials_events.randomize_object_pose,
        mode="reset",
        params={
            "pose_range": {"x": (0.4, 0.6), "y": (-0.10, 0.10), "z": (0.0203, 0.0203), "yaw": (-1.0, 1, 0)},
            "min_separation": 0.1,
            "asset_cfgs": [SceneEntityCfg("vial")],
        },
    )


@configclass
class FrankaVialsEnvCfg(VialsEnvCfg):
